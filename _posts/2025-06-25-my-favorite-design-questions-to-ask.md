---
layout: post
title: My Favorite Design Questions to Ask
description: This is a short essay about the role of clarity in product design. I talk about invisible UI, intentional decisions, and how to keep things from getting in the way. Less noise, more function.
...
{: .q-left }
> Users judge design not by how it looks, but by how it works in their daily lives.
>
...
{: .tip }
It works so naturally that the user doesn't even think about how they're interacting with the interface.
